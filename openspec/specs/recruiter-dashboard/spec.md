...
App shell, AppBar, and dashboard homepage. Provides the application frame visible on all routes and the recruiter landing page that lists candidates and exposes entry points to other workflows.
