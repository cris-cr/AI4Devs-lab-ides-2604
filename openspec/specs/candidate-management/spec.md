...
Backend API and data model for managing candidates. Exposes REST endpoints for creating and listing candidate records, with optional CV file upload support.
